...
export const RecentWorksBannerContext = createContext();

export const RecentWorksBannerContextProvider = ({ children }) => {
...
export default RecentWorksBannerContext;

RecentWorksBannerContextProvider.propTypes = {
